import {a as e, c as t, d as n, f as r, i, l as a, m as o, n as s, o as c, p as l, r as u, s as d, u as f} from "./config-CQXB639S.js";
(function() {
...
;
function b() {
    return window.removeEventListener(`error`, _),
    window.removeEventListener(`unhandledrejection`, v),
    console.error = h,
    m = !1,
    p
}
var x = 1e3
  , ee = Symbol(`postMessageResponseTimeout`)
  , te = 0
  , ne = `*`
  , S = class {
    constructor(e, t) {
    ...
    post(e, t, n) {
        ...
        new Promise(e => {
            this.waitRes.set(te, t => {
                e(t)
            }
            ),
            setTimeout( () => {
                this.waitRes.delete(te),
                e(ee)
            }
            , r || this.baseTimeout)
        }
    ...
    on(e, t, n) {
        let {once: r, origin: i=ne} = n || {}
          , a = async n => {
            let {id: a, type: s, data: c} = n.data, l;
            s === e && (l = await t(c),
            console.log(e, r, l, c),
            (a && i === n.origin || i === ne) && n.source?.postMessage({
                fromType: e,
                id: a,
                data: l
            }, n.origin),
  ...
  , re = [`click`, `dblclick`, `contextmenu`, `mousedown`, `mouseup`, `mousemove`, `mouseenter`, `mouseleave`, `mouseover`, `mouseout`, `touchstart`, `touchmove`, `touchend`, `touchcancel`, `pointerdown`, `pointerup`, `pointermove`, `pointerenter`, `pointerleave`, `pointerover`, `pointerout`, `pointercancel`];
function ie(e) {
    return C.hasListeners(e, re)
}
function ae(e) {
    return C.getEventTypes(e).filter(e => re.includes(e))
}
function oe(e) {
    let t = ae(e)
      , n = {};
    return t.forEach(t => {
        n[t] = C.getListenerCount(e, t)
    }
    ),
    {
...
function se(e) {
    return C.getElementDebugInfo(e)
}
function ce(e=window) {
    ...
    e.__eventListenerRegistry__ = {
        ...
        getEventTypes: ae,
        getDetail: oe,
        getDebugInfo: () => C.getDebugInfo(),
        getElementDebugInfo: se
    },
    console.log(`[EnhancedEventDetector] ✅ Initialized and patched addEventListener`)
}
typeof window < `u` && ce(window);
var le = [`onClick`, `onDoubleClick`, `onContextMenu`, `onMouseDown`, `onMouseUp`, `onPointerDown`, `onPointerUp`, `onTouchStart`, `onTouchEnd`, `onDragStart`, `onDrop`, `onChange`, `onSubmit`, `onKeyDown`, `onKeyUp`];
function w(e) {
    let t = Object.keys(e).find(e => e.startsWith(`__reactFiber$`) || e.startsWith(`__reactInternalInstance$`));
    return t ? e[t] : null
}
function T(e) {
    return !e || typeof e != `object` ? !1 : le.some(t => typeof e[t] == `function`)
}
function ue(e) {
    return !e || typeof e != `object` ? [] : le.filter(t => typeof e[t] == `function`)
}
function de(e) {
    let t = w(e);
    for (; t; ) {
        if (t.memoizedProps && T(t.memoizedProps))
            return !0;
        t = t.return || null
    }
    return !1
...
function pe(e) {
    let t = w(e);
    return !t || !t.memoizedProps ? !1 : T(t.memoizedProps)
}
function E(e=window) {
    e.__reactEventDetector__ = {
        hasReactInteractionEvents: de,
        getReactInteractionEventsDetail: fe,
        hasReactInteractionEventsOnSelf: pe,
        REACT_EVENT_PROPS: le
    },
    console.log(`[ReactEventDetector] Injected to window.__reactEventDetector__`)
}
typeof window < `u` && E(window);
function D(e) {
    return e ? de(e) || ie(e) : !1
}
function me(e) {
    return e ? pe(e) || ie(e) : !1
}
function he(e) {
    let t = fe(e)
      , n = oe(e);
...
function xe() {
    window.__interactionDetector__ = {
        hasInteractionEvents: D,
        hasInteractionEventsOnSelf: me,
        getDetail: he,
        checkBySelector: ge,
        checkByPoint: _e,
        checkMultiple: ve,
        checkMultipleSelectors: ye,
        version: be
    },
    console.log(`[InteractionDetector] Global API initialized (v${be})`)
}
function Se() {
    let e = new S(window.parent);
    e.on(`checkInteraction`, e => {
        let {selector: t, x: n, y: r} = e || {};
        return t ? ge(t) : typeof n == `number` && typeof r == `number` ? _e(n, r) : {
...
var we = r((e => {
  ...
  , De = r(( (e, t) => {
    t.exports = typeof URL == `function` ? URL : Ee().URL
}
))
  , Oe = r((e => {
    var t = De();
  ...
  , Le = r((e => {
    e.SourceMapGenerator = je().SourceMapGenerator,
    e.SourceMapConsumer = Fe().SourceMapConsumer,
    e.SourceNode = Ie().SourceNode
}
))();
function Re(e, t, n) {
    let r = e[t];
...
function Be(e, t, n, r) {
    ...
    for (let t = n; t < e.length; t++) {
        ...
        for (a.lastIndex = 0; (u = a.exec(c)) !== null; ) {
            let e = ze([c], 0, u.index + u[0].length);
...
setInterval( () => {
    let e = Date.now();
    for (let[t,n] of qe.entries())
        e - n.timestamp > Je && qe.delete(t)
}
, 6e4);
async function Xe() {
    if (!Ke)
        try {
            await Le.SourceMapConsumer.initialize({
...
var Qe = `preview-inject/`;
async function $e(e, t=10, n) {
    if (!e || !e.stack)
        return {
...
`)
    ...
    for (let e of i) {
        ...
        try {
            let r = `${u}.map`
              , p = s.get(r);
            p || (p = await new Le.SourceMapConsumer(await Ge(r)),
            s.set(r, p));
            ...
            if (m.source) {
                ...
                m.line && m.column && l < t) {
                    l++;
                    try {
                        let t = await et(p, m.source, c);
                        if (t) {
                            let r = e.includes(`node_modules`), i = /\.(tsx|jsx)$/.test(e), a;
                            if (!r && i) {
                                let e = tt(t, m.line, m.column, n);
                                e && (a = {
                                    tagName: e.tagName,
                                    code: e.code,
                                    context: e.context,
...
var it = class {
    constructor() {
        this._client = new S(window.parent),
...
var ot = e => {
    let t = `/preview/fefca3eb-bf0f-469a-afed-4ceaf4e065a1/10123493`;
    return e.startsWith(t) ? e.replaceAll(t, ``) || `/` : e || `/`
}
;
async function st() {
    await await n( () => Promise.resolve().then( () => Fr).then(e => e.navigatePromise), void 0).catch(e => (console.error(e),
    Promise.resolve( () => {}
    ))),
...
var ct = new Promise(e => {
  ...
  , lt = () => window.REACT_APP_ROUTER
  , ut = new S(window.parent)
  , dt = async (e, t) => {
    await ut.post(`routeWillChange`, {
        next: ot(e)
    }, t)
}
;
...
function pt() {
    ...
    return window.open = function(t, n, r) {
        return t && typeof t == `string` && t.startsWith(`#`) ? (ft(t),
        null) : (e(t, `_blank`, r),
        null)
    }
    ,
...
var O = e => e.startsWith(`http://`) || e.startsWith(`https://`);
function ht(e) {
...
function gt() {
    let e = () => {
        ...
        e.push = async function(e, n, r) {
            return O(e) ? (window.open(e, `_blank`),
            Promise.resolve(!1)) : (await dt(e, {
                timeout: 500
            }),
            t.call(this, e, n, r))
        }
...
function _t() {
    if (!(`navigation`in window))
        ...
        ;
    let e = e => {
        ht(e.destination.url) && ut.post(`google-auth-blocked`, {
...
async function yt() {
    let e = await n( () => import(`./config-CQXB639S.js`).then(e => e.t).then(e => e.default), []).catch(e => [])
      , t = []
      , r = 0;
    function i(e, n) {
    ...
    let a = new Set;
    return t = t.filter(e => a.has(e.path) ? !1 : (a.add(e.path),
    !0)),
    t
}
async function bt() {
...
var Tt = class {
  ...
  , jt = (e, t) => {
    try {
        k.set(e, t);
        let n = Tt.getFiberFromDOMNode(e);
        n && Et.set(n, t)
    } catch {}
}
  , Mt = (e, t) => {
    if (!e)
        return e => {
            e instanceof HTMLElement && jt(e, t)
        }
        ;
...
function Nt() {
    let e = Ct.createElement
      ...
      , a = e => typeof e == `string`;
    Ct.default.createElement = function(t, n, ...r) {
...
function Pt(e) {
    ...
    let i = Tt.getFiberFromDOMNode(t);
    if (i) {
        let e = Et.get(i);
        if (e)
            return {
...
It();
var Lt = `phc_V7JMHB0fVJGRu8UHyrsj6pSL1BS76P5zD8qCi7lrTTV`
  , A = {
    colors: {
        text: `#5D5D5D`,
        white: `#FFFFFF`,
  ...
  , Vt = () => navigator.language?.toLowerCase().startsWith(`zh`) ?? !1
  , Ht = () => Vt() ? Bt.zh : Bt.en
  , Ut = () => window.innerWidth > 768 && !(`ontouchstart`in window)
  , Wt = () => {
...
function Xt() {
    ...
    function t() {
        ...
        e.type = `image/png`,
        e.rel = `icon`,
        e.href = zt.readdyLogo,
        document.head.appendChild(e);
        let t = document.createElement(`link`);
        t.rel = `stylesheet`,
        t.href = zt.fontStylesheet,
        document.head.appendChild(t)
    }
    function n(e) {
        Kt(e),
        window.open(zt.readdyLink, `_blank`)
    }
    function r() {
        ...
        e.addEventListener(`click`, e => {
            e.stopPropagation(),
            Kt(`watermark_close_button_click`),
    ...
    function i(e) {
        ...
        return i.textContent = Ht().button,
        qt(i, {
    ...
    e(`fefca3eb-bf0f-469a-afed-4ceaf4e065a1`).then(u)
}
Xt();
var j = e => typeof e == `string`
  ...
  , en = /###/g
  , tn = e => e && e.indexOf(`###`) > -1 ? e.replace(en, `.`) : e
  , nn = e => !e || j(e)
  , rn = (e, t, n) => {
    let r = j(t) ? t.split(`.`) : t
      , i = 0;
  ...
  , on = (e, t, n, r) => {
    let {obj: i, k: a} = rn(e, t, Object);
    i[a] = i[a] || [],
    i[a].push(n)
}
  , sn = (e, t) => {
    let {obj: n, k: r} = rn(e, t);
    if (n && Object.prototype.hasOwnProperty.call(n, r))
        return n[r]
}
  , cn = (e, t, n) => {
    let r = sn(e, n);
    return r === void 0 ? sn(t, n) : r
}
  , ln = (e, t, n) => {
    for (let r in t)
        r !== `__proto__` && r !== `constructor` && (r in e ? j(e[r]) || e[r]instanceof String || j(t[r]) || t[r]instanceof String ? n && (e[r] = t[r]) : ln(e[r], t[r], n) : e[r] = t[r]);
    return e
}
  , un = e => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, `\\$&`)
  , dn = {
  ...
  , gn = (e, t, n) => {
    t ||= ``,
    n ||= ``;
    let r = mn.filter(e => t.indexOf(e) < 0 && n.indexOf(e) < 0);
    if (r.length === 0)
        return !0;
    let i = hn.getRegExp(`(${r.map(e => e === `?` ? `\\?` : e).join(`|`)})`)
      , a = !i.test(e);
    if (!a) {
        let t = e.indexOf(n);
  ...
  , bn = new class e {
    ...
    forward(e, t, n, r) {
        return r && !this.debug ? null : (j(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`),
        this.logger[t](e))
    }
    create(t) {
  ...
  , Sn = class extends xn {
    ...
    getResource(e, t, n, r={}) {
        ...
        n && (Array.isArray(n) ? o.push(...n) : j(n) && i ? o.push(...n.split(i)) : o.push(n)));
        let s = sn(this.data, o);
        return !s && !t && !n && e.indexOf(`.`) > -1 && (e = o[0],
        t = o[1],
        n = o.slice(2).join(`.`)),
        s || !a || !j(n) ? s : _n(this.data?.[e]?.[t], n, i)
    }
    ...
    addResources(e, t, n, r={
        ...
        for (let r in n)
            (j(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], {
                silent: !0
            });
...
var Dn = {}
  , On = e => !j(e) && typeof e != `boolean` && typeof e != `number`
  , kn = class e extends xn {
    constructor(e, t={}) {
        super(),
        $t([`resourceStore`, `languageUtils`, `pluralResolver`, `interpolator`, `backendConnector`, `i18nFormat`, `utils`], e, this),
        this.options = t,
        this.options.keySeparator === void 0 && (this.options.keySeparator = `.`),
    ...
    extractFromKey(e, t) {
        ...
        let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator
          ...
          , a = n && e.indexOf(n) > -1
          , o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !gn(e, n, r);
        if (a && !o) {
    ...
    translate(t, n, r) {
        ...
        let p = this.resolve(t, i)
          ...
          , S = ne && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${ee}`] || i[`defaultValue${te}`] || i.defaultValue
          , C = m;
        y && !m && x && (C = S);
        let re = On(C)
        ...
        if (y && C && re && _.indexOf(ie) < 0 && !(j(v) && Array.isArray(C))) {
            if (!i.returnObjects && !this.options.returnObjects) {
                ...
                let e = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(h, C, {
                    ...i,
                    ns: c
            ...
            let a = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && n ? void 0 : m
              , c = x && S !== m && this.options.updateMissing;
            if (n || e || c) {
                if (this.logger.log(c ? `updateKey` : `missingKey`, d, l, s, c ? S : m),
                o) {
    ...
    extendTranslation(e, t, n, r, i) {
        ...
        let a = n.postProcess || this.options.postProcess
          , o = j(a) ? [a] : a;
        return e != null && o?.length && n.applyPostProcessor !== !1 && (e = Cn.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
            i18nResolved: {
                ...r,
    ...
    resolve(e, t={}) {
        ...
        e.forEach(e => {
            ...
            let u = t.count !== void 0 && !j(t.count)
              ...
              , f = t.context !== void 0 && (j(t.context) || typeof t.context == `number`) && t.context !== ``
              , p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
            l.forEach(e => {
                this.isValidLookup(n) || (o = e,
                !Dn[`${p[0]}-${e}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (Dn[`${p[0]}-${e}`] = !0,
  ...
  , An = class {
    ...
    toResolveHierarchy(e, t) {
        ...
        ;
        return j(e) && (e.indexOf(`-`) > -1 || e.indexOf(`_`) > -1) ? (this.options.load !== `languageOnly` && i(this.formatLanguageCode(e)),
        this.options.load !== `languageOnly` && this.options.load !== `currentOnly` && i(this.getScriptPartFromCode(e)),
        this.options.load !== `currentOnly` && i(this.getLanguagePartFromCode(e))) : j(e) && i(this.formatLanguageCode(e)),
        n.forEach(e => {
  ...
  , Nn = class {
    ...
    getSuffixes(e, t={}) {
        let n = this.getRule(e, t);
        return n ||= this.getRule(`dev`, t),
        n ? n.resolvedOptions().pluralCategories.sort( (e, t) => jn[e] - jn[t]).map(e => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ``}${e}`) : []
    }
    getSuffix(e, t, n={}) {
    ...
    interpolate(e, t, n, r) {
        let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = e => {
            if (e.indexOf(this.formatSeparator) < 0) {
                let i = Pn(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
            ...
            return this.format(Pn(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
                ...r,
                ...t,
                interpolationkey: a
            })
        ...
        return [{
            ...
            regex: this.regexp,
            safeValue: e => this.escapeValue ? Fn(this.escape(e)) : Fn(e)
        }].forEach(t => {
            for (o = 0; i = t.regex.exec(e); ) {
                ...
                a === void 0)
                    ...
                    !j(a) && !this.useRawValueToEscape && (a = Qt(a));
                let s = t.safeValue(a);
  ...
  , Bn = class {
    ...
    init(e, t={
        ...
        let n = t.cacheInBuiltFormats ? Rn : zn;
        this.formats = {
            number: n( (e, t) => {
    ...
    format(e, t, n, r={}) {
        ...
        return i.reduce( (e, t) => {
            let {formatName: i, formatOptions: a} = Ln(t);
            if (this.formats[i]) {
                let t = e;
                try {
...
e)
  ...
  , qn = class e extends xn {
    ...
    init(e={}, t) {
        ...
        e = {}),
        e.defaultNS == null && e.ns && (j(e.ns) ? e.defaultNS = e.ns : e.ns.indexOf(`translation`) < 0 && (e.defaultNS = e.ns[0]));
        let n = Un();
        this.options = {
            ...n,
            ...this.options,
        ...
        if (!this.options.isClone) {
            this.modules.logger ? bn.init(r(this.modules.logger), this.options) : bn.init(null, this.options);
            let e;
            e = this.modules.formatter ? this.modules.formatter : Bn;
            let t = new An(this.options);
            this.store = new Sn(this.options.resources,this.options);
            let i = this.services;
            i.logger = bn,
            i.resourceStore = this.store,
            i.languageUtils = t,
            i.pluralResolver = new Nn(t,{
            ...
            i.interpolator = new In(this.options),
            i.utils = {
                hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
            },
            i.backendConnector = new Hn(r(this.modules.backend),i.resourceStore,i,this.options),
            ...
            this.translator = new kn(this.services,this.options),
    ...
    use(e) {
        ...
        e.type === `postProcessor` && Cn.addPostProcessor(e),
    ...
    changeLanguage(e, t) {
        ...
        let r = e => {
          ...
          , a = t => {
            ...
            let n = j(t) ? t : t && t[0]
              , a = this.store.hasLanguageSomeTranslations(n) ? n : this.services.languageUtils.getBestMatchFromCodes(j(t) ? [t] : t);
            a && (this.language || r(a),
    ...
    getFixedT(e, t, n) {
        let r = (e, t, ...i) => {
            ...
            return a.keyPrefix && Array.isArray(e) ? s = e.map(e => (typeof e == `function` && (e = En(e, t)),
            `${a.keyPrefix}${o}${e}`)) : (typeof e == `function` && (e = En(e, t)),
            s = a.keyPrefix ? `${a.keyPrefix}${o}${e}` : e),
            this.t(s, a)
        }
        ;
        return j(e) ? r.lng = e : r.lngs = e,
        r.ns = t,
        r.keyPrefix = n,
        r
    }
    ...
    loadNamespaces(e, t) {
        let n = Zt();
        return this.options.ns ? (j(e) && (e = [e]),
        e.forEach(e => {
            this.options.ns.indexOf(e) < 0 && this.options.ns.push(e)
        }
        ),
    ...
    dir(e) {
        ...
        let t = `ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb`.split(`.`)
          , n = this.services?.languageUtils || new An(Un());
    ...
    cloneInstance(t={}, n=Gn) {
        ...
        r && (a.store = new Sn(Object.keys(this.store.data).reduce( (e, t) => (e[t] = {
            ...this.store.data[t]
        },
        ...
        a.translator = new kn(a.services,i),
        a.translator.on(`*`, (e, ...t) => {
            a.emit(e, ...t)
        }
        ),
  ...
  , Jn = qn.createInstance();
Jn.createInstance = qn.createInstance,
Jn.createInstance,
Jn.dir,
Jn.init,
Jn.loadResources,
...
Jn.t,
Jn.exists,
Jn.setDefaultNamespace,
Jn.hasLoadedNamespace,
Jn.loadNamespaces,
Jn.loadLanguages;
function Yn({i18n: e, defaultNS: t, children: n}) {
    let r = (0,
    Ct.useMemo)( () => ({
        i18n: e,
        defaultNS: t
    ...
    return (0,
    Ct.createElement)(d.Provider, {
        value: r
    }, n)
}
var {slice: Xn, forEach: Zn} = [];
function Qn(e) {
    return Zn.call(Xn.call(arguments, 1), t => {
        if (t)
            for (let n in t)
                e[n] === void 0 && (e[n] = t[n])
    }
...
var er = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/
  ...
  , sr = () => {
    if (or !== null)
        return or;
    try {
        if (or = typeof window < `u` && window.localStorage !== null,
        !or)
            return !1;
  ...
  , cr = {
    ...
    cacheUserLanguage(e, t) {
        ...
        n && sr() && window.localStorage.setItem(n, e)
    }
}
  , lr = null
  , ur = () => {
    if (lr !== null)
        return lr;
    try {
        if (lr = typeof window < `u` && window.sessionStorage !== null,
        !lr)
            return !1;
        let e = `i18next.translate.boo`;
  ...
  , dr = {
    ...
    cacheUserLanguage(e, t) {
        ...
        n && ur() && window.sessionStorage.setItem(n, e)
    }
}
  , fr = {
    name: `navigator`,
...
var _r = [`querystring`, `cookie`, `localStorage`, `sessionStorage`, `navigator`, `htmlTag`];
gr || _r.splice(1, 1);
var vr = () => ({
    order: _r,
  ...
  , yr = class {
    ...
    init() {
        ...
        this.services = e,
        this.options = Qn(t, this.options || {}, vr()),
    ...
    detect() {
        ...
        t = t.filter(e => e != null && !$n(e)).map(e => this.options.convertDetectedLanguage(e)),
...
var br = l({
  ...
  , xr = {
    ...
    heroDescription: `اختر مطعمك المفضل، أضف طلباتك للسلة، وتتبع طلبك مباشرة حتى يصل باب منزلك.`,
    heroTrackCta: `تتبع طلبك`,
    heroBadge: `توصيل سريع وموثوق`,
    searchPlaceholder: `ابحث عن مطعم...`,
    restaurantsTitle: `المطاعم المميزة`,
    restaurantsSubtitle: `اكتشف أفضل المطاعم في منطقتك`,
    deliveryTime: `دقيقة`,
    viewMenu: `عرض المنيو`,
    rating: `تقييم`,
    restaurantsCountSuffix: `مطعم`,
    ...
    cashOnDelivery: `الدفع نقداً عند استلام الطلب`,
    cardPayment: `الدفع بالبطاقة البنكية (يتطلب ربط Stripe)`,
    browseRestaurants: `تصفح المطاعم`,
    backToHome: `العودة للرئيسية`,
    trackTitle: `تتبع طلبك`,
    trackDesc: `أدخل رقم التتبع الخاص بطلبك لمتابعة حالته`,
    ...
    orderTime: `وقت الطلب`,
    orderNotFound: `لم يتم العثور على طلب`,
    checkTrackingCode: `تأكد من رقم التتبع وأعد المحاولة`,
    ...
    footerRights: `جميع الحقوق محفوظة © Foodi 2026`,
    category_burger: `برجر`,
    category_pizza: `بيتزا`,
    category_shawarma: `شاورما`,
    category_sushi: `سوشي`,
    category_cafe: `كافيه`,
    category_grill: `مشاوي`,
    category_extras: `إضافات`,
    category_drinks: `مشروبات`,
    category_chicken_wings: `أجنحة دجاج`,
    category_bowls: `صحون`,
    category_noodles: `نودلز`,
    category_coffee: `قهوة`,
    ...
    thankYouOrder: `شكراً لطلبك! سنبدأ التحضير مباشرة.`,
    telegramSent: `تم إرسال إشعار Telegram للأدمن`,
    telegramSkipped: `لم يتم إرسال إشعار Telegram (يربط Supabase لاحقاً)`
}
  , Sr = l({
    default: () => Cr,
    enTranslations: () => Cr
            ...
            try {
                a: {
                    ...
                    try {
                        b: {
                            for (b(t),
                            d = n(c); d !== null && !(d.expirationTime > t && C()); ) {
                                var o = d.callback;
...
` + e.stack
    ...
    var mt = Math.random().toString(36).slice(2)
      , O = `__reactFiber$` + mt
      , ht = `__reactProps$` + mt
      , gt = `__reactContainer$` + mt
      , _t = `__reactEvents$` + mt
      , vt = `__reactListeners$` + mt
    ...
    function Gt(e, t, n, r, i, a, o, s) {
        ...
        t == null ? o !== `submit` && o !== `reset` || e.removeAttribute(`value`) : o === `number` ? (t === 0 && e.value === `` || e.value != t) && (e.value = `` + A(t)) : e.value !== `` + A(t) && (e.value = `` + A(t)),
        t == null ? n == null ? r != null && e.removeAttribute(`value`) : qt(e, o, A(n)) : qt(e, o, A(t)),
        i == null && a != null && (e.defaultChecked = !!a),
        i != null && (e.checked = i && typeof i != `function` && typeof i != `symbol`),
        s != null && typeof s != `function` && typeof s != `symbol` && typeof s != `boolean` ? e.name = `` + A(s) : e.removeAttribute(`name`)
    }
    ...
    function $t(e, t, n) {
        ...
        n != null) {
            ...
            for (var a in t)
                r = t[a],
                t.hasOwnProperty(a) && n[a] !== r && Qt(e, a, r)
        } else
            for (var o in t)
    ...
    function wn(e) {
        function t(t, n, r, i, a) {
            ...
            e)
                ...
                this[o] = t ? t(i) : i[o]);
            return this.isDefaultPrevented = (i.defaultPrevented == null ? !1 === i.returnValue : i.defaultPrevented) ? Sn : Cn,
    ...
    var Tn = {
        ...
        movementX: function(e) {
            return `movementX`in e ? e.movementX : (e !== jn && (jn && e.type === `mousemove` ? (kn = e.screenX - jn.screenX,
            An = e.screenY - jn.screenY) : An = kn = 0,
            jn = e),
            kn)
        },
    ...
    var Wn = wn(p({}, Dn, {
        key: function(e) {
            ...
            return e.type === `keypress` ? (e = xn(e),
            e === 13 ? `Enter` : String.fromCharCode(e)) : e.type === `keydown` || e.type === `keyup` ? Bn[e.keyCode] || `Unidentified` : ``
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
    ...
    function sr(e, t) {
        if (ar)
            return e === `compositionend` || !Zn && rr(e, t) ? (e = bn(),
            yn = vn = _n = null,
            ar = !1,
            e) : null;
        switch (e) {
    ...
    function ur(e, t, n, r) {
        ...
        t = Ed(t, `onChange`),
        0 < t.length && (n = new En(`onChange`,`change`,null,n,r),
        e.push({
            event: n,
            listeners: t
        }))
    ...
    function Vr(e, t, n) {
        ...
        zr && Or(zr, r) || (zr = r,
        r = Ed(Rr, `onSelect`),
        0 < r.length && (t = new En(`onSelect`,`select`,null,t,n),
        e.push({
            event: t,
            listeners: r
        }),
    ...
    var Ur = {
      ...
      , Wr = {}
      , Gr = {};
    mn && (Gr = document.createElement(`div`).style,
    ...
    function Ma(e, t, n) {
        switch (n = e[n],
        n === void 0 ? e.push(t) : n !== t && (t.then(an, an),
        t = n),
        t.status) {
        case `fulfilled`:
            return t.value;
    ...
    function Ha(e) {
        ...
        function l(e, t, n, r) {
            var i = n.type;
            return i === _ ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === C && Na(i) === t.type) ? (t = a(t, n.props),
            Ba(t, n),
            t.return = e,
    ...
    function qs(e, t, n, r, i, a, o) {
        ...
        typeof e.shouldComponentUpdate == `function` ? e.shouldComponentUpdate(r, a, o) : t.prototype && t.prototype.isPureReactComponent ? !Or(n, r) || !Or(i, a) : !0
    }
    function Js(e, t, n, r) {
        e = t.state,
    ...
    function Pc(e, t, n) {
        ...
        case 27:
            return be(t),
            e === null && N && (r = t.stateNode = ff(t.type, t.pendingProps, ge.current),
            Bi = t,
            Hi = !0,
            a = M,
            Zd(t.type) ? (lf = a,
            ...
            o === null)
                        ...
                        for (e = t.child; e !== null; ) {
                            ...
                            o !== null) {
                                ...
                                n = t.child; n !== null; )
                                    vi(n, e),
                                    n = n.sibling;
                                return D(F, F.current & 1 | 2),
                                N && Fi(t, r.treeForkCount),
                                t.child
                            }
                            e = e.sibling
                        }
                    r.tail !== null && Pe() > tu && (t.flags |= 128,
                    a = !0,
                    zc(r, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a)
                    ...
                    e !== null) {
                        ...
                        2 * Pe() - r.renderingStartTime > tu && n !== 536870912 && (t.flags |= 128,
                        a = !0,
                        zc(r, !1),
                        t.lanes = 4194304);
    ...
    function vl(e, t) {
                        ...
                        if (e.stateNode === null) {
                            a: {
                                ...
                                case `title`:
                                    ...
                                    (!o || o[xt] || o[O] || o.namespaceURI === `http://www.w3.org/2000/svg` || o.hasAttribute(`itemprop`)) && (o = a.createElement(r),
        ...
        case 13:
            gl(t, e),
            yl(e),
            e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && ($l = Pe()),
            r & 4 && (r = e.updateQueue,
            r !== null && (e.updateQueue = null,
            hl(e, r)));
            break;
    ...
    function Ku(e, t, n) {
        ...
        e.warmLanes &= ~n,
        K === e && (J & n) === n && (X === 4 || X === 3 && (J & 62914560) === J && 300 > Pe() - $l ? !(G & 2) && Su(e, 0) : ql |= n,
        Yl === J && (Yl = 0)),
        rd(e)
    }
    function qu(e, t) {
    ...
    function cd(e, t) {
        ...
        if (Hu() && e.callbackNode !== n)
            return null;
        var r = J;
        return r = et(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1),
        r === 0 ? null : (gu(e, r, t),
        sd(e, Pe()),
    ...
    function md(e, t, n, r, i) {
        if (t === `submit` && n && n.stateNode === i) {
            var a = fd((i[ht] || null).action)
              , o = r.submitter;
            o && (t = (t = o[ht] || null) ? fd(t.formAction) : o.getAttribute(`formAction`),
            t !== null && (a = t,
            o = null));
        ...
        fn(function() {
            ...
            a: {
                ...
                if (c !== void 0) {
                    ...
                    for (var m = r, h; m !== null; ) {
                        ...
                        if (h = g.stateNode,
                        g = g.tag,
                        g !== 5 && g !== 26 && g !== 27 || h === null || p === null || (g = pn(m, p),
            ...
            if (!(t & 7)) {
                a: {
                    ...
                    c && n !== on && (u = n.relatedTarget || n.fromElement) && (Ct(u) || u[gt]))
                        break a;
                    ...
                    l !== u)) {
                        ...
                        p = `onMouseEnter`,
                        m = `mouse`,
                        (e === `pointerout` || e === `pointerover`) && (d = Gn,
                        g = `onPointerLeave`,
                        p = `onPointerEnter`,
                        m = `pointer`),
                        f = l == null ? c : Tt(l),
                        ...
                        c.relatedTarget = h,
                        g = null,
                        Ct(i) === r && (d = new d(p,m + `enter`,u,n,i),
                        d.target = h,
                        d.relatedTarget = f,
                        g = d),
                        f = g,
                ...
                x && (er && n.locale !== `ko` && (ar || x !== `onCompositionStart` ? x === `onCompositionEnd` && ar && (b = bn()) : (_n = i,
                vn = `value`in _n ? _n.value : _n.textContent,
                ar = !0)),
                y = Ed(r, x),
                0 < y.length && (x = new Rn(x,e,null,n,i),
                s.push({
                    event: x,
                    listeners: y
                }),
                ...
                0 < x.length && (y = new Rn(`onBeforeInput`,`beforeinput`,null,n,i),
                s.push({
                    event: y,
                    listeners: x
                }),
    ...
    function Od(e, t, n, r, i) {
        for (var a = t._reactName, o = []; n !== null && n !== r; ) {
            ...
            i ? (l = pn(n, a),
            l != null && o.unshift(Td(n, l, c))) : i || (l = pn(n, a),
...
`).replace(Ad, ``)
    ...
    function $(e, t, n, r, a, o) {
        switch (n) {
        case `children`:
            typeof r == `string` ? t === `body` || t === `textarea` && r === `` || j(e, r) : (typeof r == `number` || typeof r == `bigint`) && t !== `body` && j(e, `` + r);
            break;
        case `className`:
            It(e, `class`, r);
            break;
        ...
        case `textContent`:
            break;
        default:
            (!(2 < n.length) || n[0] !== `o` && n[0] !== `O` || n[1] !== `n` && n[1] !== `N`) && (n = tn.get(n) || n,
            Ft(e, n, r))
        }
    }
    function Nd(e, t, n, r, a, o) {
        ...
        case `dangerouslySetInnerHTML`:
            ...
            break;
        case `children`:
            typeof r == `string` ? j(e, r) : (typeof r == `number` || typeof r == `bigint`) && j(e, `` + r);
            break;
        case `onScroll`:
            r != null && Q(`scroll`, e);
            break;
            ...
            i && i.nodeType === 8)
                ...
                n === `/$` || n === `/&`) {
                    ...
                    for (var a = n.firstChild; a; ) {
                        var o = a.nextSibling
                          , s = a.nodeName;
                        a[xt] || s === `SCRIPT` || s === `STYLE` || s === `LINK` && a.rel.toLowerCase() === `stylesheet` || n.removeChild(a),
                        a = o
                    }
                } else
    ...
    function Vf(e, t, n) {
        ...
        i = 0; i < n.length; i++) {
            var a = n[i];
            if (!(a[xt] || a[O] || e === `link` && a.getAttribute(`rel`) === `stylesheet`) && a.namespaceURI !== `http://www.w3.org/2000/svg`) {
...
function zr() {
    ...
    Ct.useEffect)( () => {
        ...
        document.documentElement.lang = e.language
    }
    , [e, e.language]),
    null
}
function Br() {
    ...
    wt.jsx)(Yn, {
        ...
        children: (0,
        wt.jsxs)(u, {
            basename: `/preview/fefca3eb-bf0f-469a-afed-4ceaf4e065a1/10123493`,
            children: [(0,
            wt.jsx)(zr, {}), (0,
            wt.jsx)(Rr, {})]
        })
...
(0,
Pr.createRoot)(document.getElementById(`root`)).render((0,
wt.jsx)(Ct.StrictMode, {
    children: (0,
    wt.jsx)(Br, {})
}));
//# sourceMappingURL=index-BSpb6F59.js.map
